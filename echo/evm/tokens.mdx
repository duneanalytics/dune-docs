...
To fetch tokens for all supported chains, pass the `chain_ids=all` parameter. See [EVM Supported Chains](./balance-chains) for more details. You can also specify specific chains with `?chain_ids=11,250,1`.

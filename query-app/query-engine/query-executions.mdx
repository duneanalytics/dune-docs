...
>
  ...
  <Tab title="API query execution">
    ...
    [→ API executions](/api-reference/query-api/endpoint/execute-query.mdx)

  </Tab>
  <Tab title="popular dashboard executions">
    Popular dashboards are automatically refreshed based on their popularity. We measure popularity based on the number of views a dashboard has received. The most popular dashboards are refreshed every hour, the less popular dashboards are refreshed every 24 hours. Popular dashboards are refreshed via the community cluster.

  ![](/query-app/query-engine/images/popular-dashboard.jpeg)
  </Tab>
</Tabs>
...
<CardGroup cols={2}>
  <Card title="Interactive executions" icon="arrow-pointer" iconType="duotone" href="/query-app/web-app/query-editor/query-window">
    Trigger: user clicks "Run" button in query editor or refreshes dashboard
  </Card>
  <Card title="Scheduled executions" icon="calendar" iconType="duotone" href="/query-app/web-app/query-editor/query-scheduler">
    Trigger: scheduled dashboard or query
  </Card>
  <Card title="API executions" icon="square-terminal" iconType="duotone" href="/api-reference/query-api/endpoint/execute-query">
    Trigger: API call

  </Card>
  <Card title="Popular dashboards" icon="window" iconType="duotone" href="">

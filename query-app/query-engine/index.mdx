...
<CardGroup cols={2}>
  <Card
    ...
    icon="function"
    iconType="duotone"
    href="/query-app/query-engine/Functions-and-operators/"
  >
...
<CardGroup cols={2}>
  <Card
    ...
    icon="database"
    iconType="duotone"
    href="/query-app/query-engine/datatypes.mdx"
  >
...
<CardGroup cols={2}>
  <Card
    ...
    icon="lock"
    iconType="duotone"
    href="/query-app/query-engine/reserved-keywords"
  >
...
<CardGroup cols={2}>
  <Card
    ...
    icon="search"
    iconType="duotone"
    href="/query-app/query-engine/query-a-query"
  >

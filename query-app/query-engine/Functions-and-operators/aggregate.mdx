...
See [Quantile digest functions](/query-app/query-engine/Functions-and-operators/qdigest).
...
See [T-Digest functions](/query-app/query-engine/Functions-and-operators/tdigest).

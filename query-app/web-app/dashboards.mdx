...
description: Dashboards are where Dune's content lives and gets discovered. 
---
...
<div
  style={{
    position: "relative",
    paddingBottom: "calc(56.99999999999999% + 41px)",
    height: 0
  }}
>
  <iframe
    src="https://demo.arcade.software/tcRqeUZ7qVNahQImdVsw?embed"
    frameBorder={0}
    loading="lazy"
    webkitallowfullscreen=""
    mozallowfullscreen=""
    ...
    title="Rocket Pool Minipools by ETH Bond vs. Time"
  />
</div>
...
You can also schedule individual queries to be refreshed. This is useful if you have a Dashboard with many queries and only want to refresh a few of them. Learn more about scheduling queries [here](/query-app/web-app/query-editor/query-scheduler).

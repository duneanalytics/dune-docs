...
<Tabs>
  <Tab title="Bar charts">
    ![bar chart example](/app/images/charts-graphs/bar-chart-example.png)
  </Tab>
  <Tab title="Area charts">
    ![area chart example](/app/images/charts-graphs/area-chart.png)
  </Tab>
  <Tab title="Scatter charts">
    ![scatter chart example](/app/images/charts-graphs/scatter-chart-example.png)
  </Tab>
  <Tab title="Line charts">
    ![line chart example](/app/images/charts-graphs/line-chart-example.png)
  </Tab>
  <Tab title="Pie charts">
    ![pie chart example](/app/images/charts-graphs/pie-chart-example.png)
  </Tab>
  <Tab title="Mixed graph">
    ![mixed graph example](/app/images/charts-graphs/mixed-graph-example.png)
  </Tab>
</Tabs>
...
![all visualization configuration options](/app/images/charts-graphs/all-visualization-configuration-options.png)
...
<Tabs>
  <Tab title="Chart options">
    ...
    ![see explanations below](/app/images/charts-graphs/graphs-4.png)
  ...
  <Tab title="Result data">
    ...
    ![see explanations below](/app/images/charts-graphs/graphs-5.png)
  ...
  <Tab title="X-axis options">
    ...
    ![see explanations below](/app/images/charts-graphs/graphs-6.png)
    ...
    * Ticking this box will make your x-axis values display \_\_ logarithmically.
    ...
    ![see explanations below](/app/images/charts-graphs/graphs-7.png)
    ...
    * You can choose in the [chart series section](/app/visualizations/charts-graphs#ordering-your-series) what you want to be displayed on the left and right axis.
  </Tab>
    <Tab title="Series options">

    ![](/app/images/charts-graphs/graphs-9.png)
    ...
    **Picking Colors**
    ...
    ![Choose any color you want!](/app/images/charts-graphs/graphs-color.gif)
  </Tab>
    <Tab title="Pie options">
    ![pie options](/app/images/charts-graphs/pie-options.png)
...
![](/app/images/charts-graphs/graphs-8.png)

...
![query results table example](/query-app/web-app/images/other-visualizations/query-results-table-example.png)
...
![new table visualization](/query-app/web-app/images/other-visualizations/new-table-visualization.png)

### Configuring your Table

![table configuration options](/query-app/web-app/images/other-visualizations/table-configuration-options.png)
...
![table title example](query-app/web-app/images/other-visualizations/table-title-example.png)
...
<Tabs>
  ...
  <Tab title="Format">
    Allows you to adjust the numerical format of your data following the [X/Y-axis Tick and Label formats here](/query-app/web-app/visualizations/charts-graphs).
  </Tab>
...
<Tabs>
  <Tab title="Type">
    ...
    ![progress bar example](query-app/web-app/images/other-visualizations/progress-bar-example.gif)

  </Tab>
  <Tab title="Colored Values">
    ![colored values example](query-app/web-app/images/other-visualizations/colored-values-example.jpeg)
  </Tab>
</Tabs>
...
Our decoding process begins with our [contract submission page](https://dune.com/docs/query-app/web-app/decoding-contracts/).

![](/query-app/web-app/images/decoding-contracts/1.png)
...
![](/query-app/web-app/images/decoding-contracts/2.png)
...
![The search bar and >> symbol that will help you get started](/query-app/web-app/images/decoding-contracts/3.png)

Then it's all ready for you to query. Let the data flow! 

## B. Frequently Asked Questions

<Accordion title="On which chains does this work?">
    Any contracts created on blockchains that Dune has integrated. 
...
<Accordion title="How do I figure out if my contract has been decoded?">
    ...
    *If the contract is rejected, hover your mouse over the status to see the reason for the rejection. 
    ...
    ![](/query-app/web-app/images/decoding-contracts/4.png)
...
We avoid monitoring the implementation contract's address because its logic is accessed in transactions via the DelegateCall function.
...
<Accordion title="Accordion">
    ...
    ![new proxy implementation submission](/query-app/web-app/images/decoding-contracts/5.png)
...
<Accordion title="My submission got rejected, why?">
    ...
    **Enter the contract that you wish to decode and hit enter to run:**
    ...
    ![check if contract is decoded](/query-app/web-app/images/decoding-contracts/check_decoding_input_address.png)

    **Viewing results:**

    ![query results to determine whether contract is decoded](/query-app/web-app/images/decoding-contracts/check_decoding_result_output.png)

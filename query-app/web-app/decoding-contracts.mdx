...
![](/app/images/decoding-contracts/1.png)
...
![](/app/images/decoding-contracts/2.png)
...
![The search bar and >> symbol that will help you get started](/app/images/decoding-contracts/3.png)
...
<Accordion title="How do I figure out if my contract has been decoded?">
    ...
    *If the contract is rejected, hover your mouse over the status to see the reason for the rejection. 
    ...
    ![](/app/images/decoding-contracts/4.png)
...
<Accordion title="Accordion">
    ...
    ![new proxy implementation submission](/app/images/decoding-contracts/5.png)

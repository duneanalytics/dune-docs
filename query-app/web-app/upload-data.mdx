...
<Tip>
    You can also upload data via the API. Check out the [API documentation](/api-reference/upload/endpoint/upload) for more information.
</Tip>
...
![upload data](query-app/web-app/images/upload_data.gif)
...
To check whether the datatypes are correctly inferred, you can check the table details in the [data explorer](/query-app/web-app/query-editor/data-explorer).

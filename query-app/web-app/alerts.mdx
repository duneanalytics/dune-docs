...
![Default email alert](/query-app/web-app/images/alerts/email_table.png)

If you have defined a visualization, we will include it instead of the table, like this:

![Email Alert with visualization](/query-app/web-app/images/alerts/email_viz.png)
...
![Email Alert with multiple visualizations](/query-app/web-app/images/alerts/email_complex.png)
...
![Slack Setup](/query-app/web-app/images/alerts/slack_setup.png)

Once saved, you will start receiving messages on Slack. Here is an example of how it looks:

![Slack message](/query-app/web-app/images/alerts/slack_hook.png)
...
![Manual hook](/query-app/web-app/images/alerts/manual_hook.png)

Your setup on Zapier should look something like this:

![Zapier zap](/query-app/web-app/images/alerts/zapier_example.png)

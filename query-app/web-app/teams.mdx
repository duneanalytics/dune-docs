...
![Team content](/query-app/web-app/images/teams/teams-1.png)
...
![](/query-app/web-app/images/context-switcher.jpeg)
...
In the [Version History](/query-app/web-app/query-editor/version-history) edits you make will be attributed to your personal account, even if you are in your Team's context.

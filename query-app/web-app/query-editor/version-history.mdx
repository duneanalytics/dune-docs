...
![](/query-app/web-app/query-editor/images/version-history/version_start.PNG)
...
![](/query-app/web-app/query-editor/images/version-history/version_saved.PNG)

You can then edit the metadata of the saved version to make it easier to find in the future. 

![](/query-app/web-app/query-editor/images/version-history/simplified_query.gif)
...
![](/query-app/web-app/query-editor/images/version-history/compare_query.gif)
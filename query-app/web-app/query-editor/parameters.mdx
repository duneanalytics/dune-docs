...
![list parameter](/query-app/web-app/query-editor/images/parameters/list-parameter.jpeg)
...
![parameter from query results](/query-app/web-app/query-editor/images/parameters/parameter-query-result.jpeg)


<Note>
**Query results**

    The query that you use to populate the list of values does not update automatically. You need to trigger a refresh of the query results to update the list of values. This can happen by either manually refreshing the query results or by setting up a [query schedule](query-app/web-app/query-editor/query-scheduler).
</Note>

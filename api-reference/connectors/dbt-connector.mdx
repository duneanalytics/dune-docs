...
<Card title="dbt Template Repository" icon="github" href="https://github.com/duneanalytics/dune-dbt-template">
  Get started quickly with our official dbt template repository, featuring example models for all incremental strategies and CI/CD workflows.
</Card>
...
- Run OPTIMIZE and VACUUM periodically on large tables

---
title: "DuneSQL Trino/Presto Connector"
...
<CardGroup cols={2}>
  ...
  <Card title="Metabase" icon="chart-bar" iconType="duotone" href="#metabase-setup-for-dune">
    Self-hosted/managed BI; connect using the Starburst/Trino driver.
  </Card>
  <Card title="Any Trino/Presto/Starburst client" icon="plug" iconType="duotone" href="#trino-presto-starburst-clients-setup-for-dune">
...
<Steps>
  ...
  <Step title="Select database">
    In the editor, choose your newly created <b>Dune SQL</b> data source from the <b>Select a database</b> dropdown.
  </Step>
...
<Steps>
  <Step title="Open Data sources">
    ...
    <Frame>
      <img src="/images/trino-presto-connector/hex-1.png" alt="Hex step 1: Open Data sources" />
    </Frame>
  </Step>
  <Step title="Add connection and choose Trino">
    Click the green <b>+ Connection</b> button, then select <b>Trino</b> from the list of available connections.
    <Frame>
      <img src="/images/trino-presto-connector/hex-2.png" alt="Hex step 2: Add connection and choose Trino" />
    </Frame>
  </Step>
  <Step title="Enter connection details">
    Fill in the form fields using the values from the <a href="#connection-parameters">Connection Parameters</a> section.
    <Frame>
      <img src="/images/trino-presto-connector/hex-3.png" alt="Hex step 3: Enter connection details" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Select data source">
    In the data source dropdown at the top of the cell, select your newly created <b>Dune SQL</b> connection.
  </Step>
  <Step title="Paste and run SQL">
    Paste the example query below into the cell and run it.
    <Frame>
      <img src="/images/trino-presto-connector/hex-4.png" alt="Hex step: Paste and run SQL" />
    </Frame>
  </Step>
</Steps>
...
<Tabs>
  ...
  <Tab title="Presto">
    This connection string is for Presto-compatible clients.
    ```text
...
<Note>
  Your Dune API Key should be provided in the password field of your client's configuration.
</Note>

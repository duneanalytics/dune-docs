...
<CardGroup cols={2}>
  <Card title="Analyze blockchain data programmatically" icon="chart-line" href="/api-reference/apis/quickstart-analyze">
  ...
  <Card title="Build real-time applications" icon="bolt" href="/api-reference/apis/quickstart-realtime">
...
<Card title="Get started with the basics" icon="rocket" href="/api-reference/quickstart/results-eg">

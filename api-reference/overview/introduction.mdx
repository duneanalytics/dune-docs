...
<Note>
**New to Dune?** <a href="https://dune.com/auth/register" style="text-decoration-color: white; font-weight: bold;">Create a free account</a> or <a href="https://dune.com/apis?tab=keys" style="text-decoration-color: white; font-weight: bold;">get your API key</a> to start building.
</Note>

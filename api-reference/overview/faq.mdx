...
The API rate limit currently varies by [subscription plan](https://dune.com/pricing). It's currently 40 per minute on Free, 200 per minute on Plus, and custom limits on Enterprise plans.

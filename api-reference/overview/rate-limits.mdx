...
- Low limit endpoints _(write-heavy operations)_
    - [create query](../queries/endpoint/create), [update query](../queries/endpoint/update), toggle private/archive query, [execute query](../executions/endpoint/execute-query), [CSV upload](../tables/endpoint/upload). 
- High limit endpoints _(read-heavy operations)_
    - [read query](../queries/endpoint/read), read result (in any form), [get execution status](../executions/endpoint/get-execution-status), [cancel execution](../executions/endpoint/cancel-execution).

...
<CardGroup cols={2}>
  ...
  >
    You can use official Trino client libraries and SDKs.
  </Card>
</CardGroup>
...
You can connect from any client that supports Trino, Presto, or Starburst, including popular tools like DBeaver, DataGrip, and DbVisualizer. While the specific setup steps will vary for each client, the core connection details remain the same.

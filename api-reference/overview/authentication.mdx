...
## Context of a key 
As mentioned above, a team API key only has access to team account resources and not user account resources. This can be especially relevant when you use Queries endpoints.

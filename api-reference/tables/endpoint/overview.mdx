...
<Note>
**Endpoint Migration Notice**: The table upload endpoints have been updated from `/v1/table/*` to `/v1/uploads/*`. The old endpoints are deprecated but still fully functional. **Request parameters and response bodies remain unchanged.**

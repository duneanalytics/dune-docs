...
- For columns of type `varbinary`, submit the data in `varchar` format. Our system will convert these to `varbinary` to enhance performance.
- Each successful `/insert` request consumes 10 credits.

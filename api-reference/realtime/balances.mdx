...
The Token Balances API provides accurate and fast (sub 500ms) real time balances of the native and ERC20 tokens of accounts on support blockchains (EVM currently).
...
```bash
https://api.dune.com/api/beta/balances/{chain}/{address}
```

...
<Note>
  ...
  - If you are using the [Python SDK](https://github.com/duneanalytics/dune-client/tree/main):
    ...
    - For [lower level functions](https://github.com/duneanalytics/dune-client/blob/main/dune_client/api/execution.py) like `get_execution_results()`, you can pass in pagination parameters `limit` and `offset` directly, as instructed [here](../executions/endpoint/pagination#pagination-parameters).
</Note>

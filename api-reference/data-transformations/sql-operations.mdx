...
This page documents all SQL statements supported via the Data Transformations API. These operations enable you to create, manage, and manipulate tables and views in your private namespace on Dune.
...
- [DuneSQL Trino Connector](/api-reference/overview/dunesql-trino-connector)

...
```
<Note>
You'll need to GET query the `data_uri` with your api key to get the results data. This is the same query endpoint as [get execution result](/api-reference/query-api/endpoint/get-execution-result).
</Note>

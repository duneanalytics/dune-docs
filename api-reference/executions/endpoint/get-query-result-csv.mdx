...
Welcome to the Examples and Tutorials section! Here, you'll find a collection of code examples and step-by-step tutorials to help you get started with retrieving query results in CSV format.

### Step-by-Step Tutorial: Retrieving Query Results in CSV Format

#### Step 1: Define the Query

Before you can retrieve query results, you need to define the query with its parameters. This includes specifying the query ID and any parameters required for the query.
...
Once you have executed the query, you can retrieve the query results by making a GET request to the results endpoint.

**Example using cURL:**

```bash
curl -X GET -H x-dune-api-key:{{api_key}} "https://api.dune.com/api/v1/query/{{query_id}}/results/csv"
```

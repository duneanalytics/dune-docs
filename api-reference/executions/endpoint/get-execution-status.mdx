...
- `QUERY_STATE_COMPLETED_PARTIAL`: The query execution was successful, but the result returned was truncated because it was too large. To get full data result, pass the `allow_partial_results = true` flag is passed in the API request.

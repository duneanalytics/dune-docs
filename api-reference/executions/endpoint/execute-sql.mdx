---
title: Execute SQL
api: "POST https://api.dune.com/api/v1/sql/execute"
...
```json
{
  "sql": "SELECT blockchain, project, version, block_time, token_sold_symbol, token_bought_symbol, amount_usd FROM dex.trades WHERE blockchain = 'ethereum' AND block_time > now() - interval '1 hour' ORDER BY amount_usd DESC LIMIT 10",
  "performance": "large"
}
```
</RequestExample>

...
#### `filters`
- **Type:** `string`
- **Description:** Allows specifying criteria to filter rows in the result set. It functions similarly to a SQL `WHERE` clause.
...
#### `columns`
- **Type:** `string`
- **Description:** Identifies specific column names to include in the result set. If omitted, all columns are returned.

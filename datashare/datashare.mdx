...
sidebarTitle: Datashare Overview
icon: star
description: Access all of Dune's blockchain data directly in your data warehouse for privacy and control.
---

Dune Datashare brings our complete blockchain dataset (1.5M+ tables, 100+ chains) directly into your data warehouse. Query blockchain data in your own environment with complete privacy and control.

## How Datashare Works

Datashare replicates Dune's processed blockchain data directly into your cloud data warehouse:

![Datashare Architecture](/datashare/images/datashare-architecture.png)

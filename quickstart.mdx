...
Dune has many more features, but these are the basics you'll need to get started. If you're looking for more advanced guides, check out the [Analytics Guidelines](/get-started/learning-resources) and [Data Tables](/data-tables/) sections.

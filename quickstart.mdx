...
Dune has many more features, but these are the basics you'll need to get started. If you're looking for more advanced guides, check out the [Analytics Guidelines](/learning/index) and [Data Tables](data-tables/index) sections.
...
And when you feel ready to do advanced analysis, check out the [next guide](/learning/index)
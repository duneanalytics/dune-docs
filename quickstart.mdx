...
Begin by constructing the SQL queries you need using Dune's **Query Editor**, a powerful tool for writing and executing SQL. Check out our detailed guide on **[writing queries](https://docs.dune.com/web-app/query-editor/query-window).**
...
- **[How to create a visualization](https://docs.dune.com/learning/how-tos/create-your-first-visualization)**
- **[Formatting tables](https://docs.dune.com/web-app/visualizations/tables)** 
- **[Fromatting graphs & charts](https://docs.dune.com/web-app/visualizations/charts-graphs)** 
- **[Using counters](https://docs.dune.com/web-app/visualizations/counters)**
...
**Important Note:** *While you can change the dashboard's display name at any time, the URL slug, created based on your initial name choice, is permanent.*

For detailed instructions on dashboard creation, widget customization, and advanced settings, refer to our comprehensive guide on **[Creating Dashboards.](https://docs.dune.com/web-app/dashboards)**

## Recap

**Congratulations, you've just queried blockchain data, created a visualization, and presented your data on Dune!**

Now, you can share your dashboard with the world. Learn more about sharing your content effectively in our guide on **[how to share Dune content.](https://docs.dune.com/learning/how-tos/share-dune-content)**

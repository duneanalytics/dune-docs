...
Dune offers many features, but this guide focuses on the essentials you'll need to get started. For more detailed guides, check out our [Analytics Guidelines](/learning-resources) and [Data Tables](/data-catalog/overview) sections.
...
![Data transformations on Dune](/images/data-transformations-dune.png)
...
*   **[Video Tutorials](/resources/learning/video-tutorials):** Watch comprehensive video guides covering all product surfaces of Dune, from getting started to advanced analysis.

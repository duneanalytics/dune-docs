export const DexTradesSnippet = ({ blockchain }) => (
  <div>
    ...
    <h2>Table Coverage Descriptions</h2>
    <p> The following table shows what projects and versions of those projects are covered in the <code>dex.trades</code> table. </p>

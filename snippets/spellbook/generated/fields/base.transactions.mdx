...
L1 Fees that the Base protocol pays to submit L2 transactions to L1 (also referred to as L1 Security Fees or Security Costs)
</ParamField>
<ParamField path="l1_fee_scalar">
This value covers the change in L1 gas price between the time the transaction is submitted and when it is published, as well as the income Base needs to keep the system running. Currently set at 1.0
</ParamField>

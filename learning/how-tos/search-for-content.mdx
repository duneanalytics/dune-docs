...
With over 100K dashboards, 700K saved queries, and a continuous influx of new content each week, navigating Dune can sometimes feel overwhelming. However, with a grasp of the basics, finding what you need becomes a breeze.
...
## Discover Page 
Navigate to the Discover page to begin your exploration. Here, you'll find four categories to delve into: dashboards, queries, analysts (our esteemed creators 🧙 on Dune), and teams.
...
- The results will display related dashboards, queries, analysts, or teams.

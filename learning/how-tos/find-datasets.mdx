...
Dune supports 30 EVM chains and many non-EVM chains like Solana, Bitcoin, NEAR and others. For a complete list of [supported chains](/data-catalog/overview), visit the [data explorer and view the full selection](https://dune.com/queries?category=canonical) under "Raw blockchain data".

![all chains on dune](learning/how-tos/images/raw_blockchain_data.png)

## Search via the Data Explorer
The data explorer is an invaluable tool for pinpointing specific datasets among the vast collection. For instance, to locate datasets for Uniswap v2 within the "Decoded" and "Curated Tables" categories, follow the steps illustrated here:
...
**Heuristics for when to use which categories**
    ...
    - Ecosystem Research: The "Raw" category is a good starting point. Alternatively, the "Curated Tables" category might have pre-aggregated data for your analysis
</Tip>

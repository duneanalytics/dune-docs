...
![dune-ai-function-example.png](/learning/how-tos/images/dune-ai-function-example.png)
...
**Prompt Engineering Tip**: 
Include project names or schemas in your prompt. Below including `blur` in the prompt will help Dune AI identify all curated tables under that schema. Blur has many curated tables but the LLM selects the most relevant one (`blur.trades`) based on the context of the prompt.
...
![dune-ai-spells-example.png](/learning/how-tos/images/dune-ai-spells-example.png)
...
![dune-ai-project-decoded-example.png](/learning/how-tos/images/dune-ai-project-decoded-example.png)
...
![dune-ai-token-example.png](/learning/how-tos/images/dune-ai-token-example.png)
...
![dune-ai-my-wallet.png](/learning/how-tos/images/dune-ai-my-wallet.png)

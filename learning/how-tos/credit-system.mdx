...
See full blog post announcement [here] (link tbd)
...
- a monthly overage limit (account-level ceiling).
...
Overage is charged at the same rate as your plan. The price per 100 credits shown for each plan is what you pay for any usage beyond your included credits, keeping things simple and transparent.
...
<AccordionGroup>
  <Accordion title="How can I monitor my credit consumption?">
    The usage and billing dashboard shows credits used, overages, and historical usage.
  </Accordion>
  ...
  <Accordion title="Can I run bigger queries now?">
    Yes more complex queries and higher data volumes with longer timeouts for Enterpris clients.
  </Accordion>
</AccordionGroup>

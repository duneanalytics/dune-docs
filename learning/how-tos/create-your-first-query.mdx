...
1. **Determine Your Data Source**: Instead of delving into the intricate raw blockchain tables to fetch gas expenditures for your wallet, utilize the pre-built, analytics-ready Spell table named [`gas.fees`](https://github.com/duneanalytics/spellbook/tree/main/models/gas). This table facilitates an effortless aggregation of gas expenses across eight EVM chains specifically for your wallet.
...
>
  <iframe
    src="https://demo.arcade.software/zTKnTWQCbjTh2fcRsCaR?embed"
    frameBorder={0}
    loading="lazy"

...
- `WHERE block_date >= NOW() - INTERVAL '30' day`: Focuses on recent activity
- `GROUP BY 1, 2`: Combines trades by day and blockchain
- `ORDER BY 1 DESC, 4 DESC`: Shows newest and highest volume trades first

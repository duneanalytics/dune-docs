...
title: "FAQs"
sidebarTitle: "FAQs"
description: "Frequently asked questions about Dune's pricing, credits, billing, plans, and more"
...
<AccordionGroup>
  ...
  <Accordion title="How do I calculate my potential monthly credit usage?">
    ...
    **API Export**
    ...
    - Legacy Premium: 1 credit = 25,000 data points (deprecated)
  </Accordion>
  ...
  <Accordion title="What happens if my credit quota runs out?">
    ...
    - Legacy Premium: $0.999 per 100 credits (deprecated)

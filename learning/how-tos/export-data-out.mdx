...
- **CSV Exports:** Available **only** to users on [Plus and Enterprise plans](https://dune.com/pricing). Each CSV file download will deduct credits depending on the size and complexity of the data extracted:
...
<Note>
    First, make sure you have an environment with the API key you just created.

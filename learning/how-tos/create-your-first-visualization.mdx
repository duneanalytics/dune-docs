...
<div style="position: relative; padding-bottom: calc(51.96629213483146% + 41px); height: 0; width: 100%;">
  <iframe
    src="https://demo.arcade.software/Ibb99hRkn1uJURUJfHm6?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true"
    title="New Query"
    frameborder="0"
    loading="lazy"
...
<div style="position: relative; padding-bottom: calc(51.96629213483146% + 41px); height: 0; width: 100%;">
  <iframe
    src="https://demo.arcade.software/EA9ntSBLGhGEBFhIQ0By?embed&embed_mobile=inline&embed_desktop=inline&show_copy_link=true"
    title="New Query"
    frameborder="0"
    loading="lazy"
    webkitallowfullscreen
...
2. If you are happy with the recommendation, click **Create Generate** to add the chart to your dashboard.
3. Otherwise, you can edit the title or the chart type and then **Create Generate** to create the chart.

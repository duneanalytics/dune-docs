...
We encourage you to explore the [data catalog](/data-catalog/overview) in the Dune app to discover the wealth of datasets available.
...
**Solution:** Dune's curated tables (like `dex.trades`, `nft.trades`) often provide even better aggregations. If a specific convenience table doesn't exist, you can often recreate it using raw or decoded data.
...
- **Dune Discord:** Join our [Discord server](https://discord.gg/dune) to ask questions and connect with thousands of other crypto data analysts.
- **Find a Query:** Fork one of the 600,000\+ public queries on Dune to get a head start.
- **Data Catalog:** Explore our comprehensive [data catalog](/data-catalog/overview) to understand available datasets.

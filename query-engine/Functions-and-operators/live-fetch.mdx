---
title: LiveFetch functions
description: LiveFetch functions send HTTP requests to a specified URL.
---
import { DuneEmbed } from '/snippets/dune-embed.mdx'

The LiveFetch functions send HTTP requests to a specified URL.
Using the LiveFetch functions, you can interact with HTTP servers directly in SQL queries.
They allow you to fetch data from external APIs, as well as invoke remote procedure calls.
...
<DuneEmbed qID={3478053} vID={5845623} height={300} />

<CardGroup cols={1}>
  <Card title="Example Dashboard" icon="chart-simple" href="https://dune.com/dune/dunesql-live-fetch-functions">
    A dashboard with examples of LiveFetch functions.
  </Card>
</CardGroup>
...
**Response size limit:** Maximum accepted response body size is 4_194_304 bytes (4 MiB).
...
### Multiple HTTP GET requests parameterized with Dune data

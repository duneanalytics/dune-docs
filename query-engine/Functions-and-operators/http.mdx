...
description: HTTP functions send HTTP requests to a specified URL.
---
...
With the HTTP functions we can e.g. pull in a list of coins from coingecko:
...
<div>
  <iframe
    src="https://dune.com/embeds/3478053/5845623/"
    width="100%"
    height="300px"
  ></iframe>
</div>
...
<CardGroup cols={1}>
  <Card title="Example Dashboard" icon="chart-simple" href="https://dune.com/dune/dunesql-http-functions">
    A dashboard with examples of HTTP functions.
  </Card>
</CardGroup>

<Warning>
The HTTP functions are only available for customers on a paid plan.
</Warning>
...
Often, the response is a JSON document. You can process it further with [JSON-processing SQL functions](/query-engine/Functions-and-operators/json.mdx).

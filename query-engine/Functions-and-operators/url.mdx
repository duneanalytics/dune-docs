...
valid URIs conforming to RFC `2396`). The following syntax is supported:
...
Returns the value of the query string parameter named `name` from `url`. Parameter extraction is handled in the typical manner as specified by RFC 1866#section-8.2.1.

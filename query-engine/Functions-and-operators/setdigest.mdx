...
description: Functions for computing set digests and HyperLogLog structures.
---
...
texts with the id 1 and 3. Due to the fact that in the example above
...
respectively 3 and 2 and therefore the similarity index for

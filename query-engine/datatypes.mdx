---
title: Datatypes
description: Overview of the data types supported in DuneSQL.
---
...
An 8-bit signed two's complement integer with a minimum value of `-2^7`
...
using the canonical format defined in [RFC 5952](https://tools.ietf.org/rfc/rfc5952.html).
...
[RFC 4122](https://tools.ietf.org/rfc/rfc4122.html).
...
A qdigest can be used to give approximate answers to queries asking for

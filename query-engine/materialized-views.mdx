...
<Info>
You can also create, manage, and refresh materialized views programmatically using the [Materialized Views API](/api-reference/materialized-views/overview).
</Info>
...
- Plans have total monthly storage limits (Enterprise has 200GB+, Plus has 15GB, Free has 100MB).

...
1. **Interactive executions** are manually triggered by a user clicking the "Run" button in the query editor page or refreshing an entire dashboard. Interactive executions can be routed via the free, medium, or large cluster, depending on the query engine selected.
...
<div style={{
  ...
  <iframe
    src="https://demo.arcade.software/PJqKnndJW9D1aFzaucJ2?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true"
    title="Run Complex Queries with Larger Engine Size on Dune Analytics"
    frameBorder={0}
    loading="lazy"
...
<div style={{
  ...
  <iframe
    src="https://demo.arcade.software/X9LhcWbsGezS6P91YrJm?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true"
    title="Change Query Engine Size Before Running a SQL Query"
    frameBorder={0}
    loading="lazy"
    webkitallowfullscreen=""
    mozallowfullscreen=""
...
<div style={{
  ...
  <iframe
    src="https://demo.arcade.software/6kkopusEA6JeKXlZJEEy?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true"
    title="Choose a Larger Query Engine for Faster SQL Execution"
    frameBorder={0}
    loading="lazy"
    webkitallowfullscreen=""
    mozallowfullscreen=""

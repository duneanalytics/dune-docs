...
<div style={{
  position: "relative",
  paddingBottom: "calc(48.95956026698076% + 41px)",
  height: 0,
  width: "100%"
}}>
  <iframe
    src="https://demo.arcade.software/lP3TpL7DJJjIDViyITIS?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true"
    title="Run a Data Query and Adjust Engine Size in Dune Analytics"
    frameBorder={0}
    loading="lazy"
...
<div style={{
  position: "relative",
  paddingBottom: "calc(53.95932496754652% + 41px)",
  height: 0,
  width: "100%"
}}>
  <iframe
    src="https://demo.arcade.software/nS29PhgEtOLbCBlOBpx7?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true"
    title="Run a Complex SQL Query with a Larger Compute Engine"
    frameBorder={0}
    loading="lazy"
    webkitallowfullscreen=""
    mozallowfullscreen=""
...
<div style={{
  ...
  <iframe
    src="https://demo.arcade.software/R2sJMX6YRBUA7tB4bzBY?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true"
    title="Run a SQL Query With a Larger Engine Size"
    frameBorder={0}
    loading="lazy"
    webkitallowfullscreen=""
    mozallowfullscreen=""

...
>
  ...
  <Tab title="API query execution">
    ...
    [→ API executions](/api-reference/executions/endpoint/execute-query.mdx)
...
<CardGroup cols={2}>
  <Card title="Interactive executions" icon="arrow-pointer" iconType="duotone" href="/web-app/query-editor/query-window">
    Trigger: user clicks "Run" button in query editor or refreshes dashboard
  </Card>
  <Card title="Scheduled executions" icon="calendar" iconType="duotone" href="/web-app/query-editor/query-scheduler">
    Trigger: scheduled dashboard or query
  </Card>
  <Card title="API executions" icon="square-terminal" iconType="duotone" href="/api-reference/executions/endpoint/execute-query">
    Trigger: API call

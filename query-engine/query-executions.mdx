...
Run queries with a larger timeout, manually or programmatically. Credits consumed based on actual compute resources used. Suitable for most standard queries and dashboards.

...
- **Data Format**: Data must be available as AVRO (preferred) or Parquet format.
- **Table Management**: You’ll need to manage the number, size, and growth rate of tables.
- **Refresh Rate**: The data will be updated on an hourly append-only basis (no row-level updates or deletes).

**Example Chains**  
To get a feel of how data on Dune looks for this integration route, check out [Polkadot](../../data-catalog/substrate/overview) or [Near](../../data-catalog/near/overview).

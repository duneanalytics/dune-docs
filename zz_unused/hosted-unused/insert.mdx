...
- For columns of type `varbinary`, submit the data in string format. See [varbinary values](/api-reference/tables/endpoint/insert#varbinary-values) for more info.

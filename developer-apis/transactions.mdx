...
It supports native and ERC20 tokens of accounts on supported blockchains, specifically EVM at the moment. 
...
The response of this endpoint is paginated using a cursor-based pagination. You can use the `limit` parameter to define the maximum page size.

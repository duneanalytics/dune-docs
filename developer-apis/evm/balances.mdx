...
openapi: 'GET /v1/balances/evm/{address}'
---
...
To fetch balances for all supported chains please pass the `chain_ids=all` parameter. See [EVM Supported Chains](./balance-evm-chains) for more details.

...
<Tip>
Watch our [Query Editor walkthrough video](/resources/learning/video-tutorials#query-editor-walkthrough) to learn how to use the query editor effectively.
</Tip>

The Query Editor is where you construct your queries. You'll probably spend most of your time here.

![Query editor](/web-app/query-editor/images/query-window/query-window.png)
...
![Explain query](/web-app/query-editor/images/query-window/explain-query.jpeg)
...
| ctrl + z      | undoes your last changes       |

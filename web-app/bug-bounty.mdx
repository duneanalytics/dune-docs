...
These adjustments will take effect on December 6th, 2024. Reports submitted before this date will be evaluated under the previous reward structure. 
...
#### Guiding Principles
To enhance transparency and fairness in the program, we are introducing the following guiding principles:
- **Recognition of Impact:** Rewards will be based on the severity, impact, and quality of the submission, ensuring fair compensation for contributions that meaningfully improve our security posture.
- **Exceptional Contributions:** While our reward structure provides standard guidance, we reserve the discretion to offer higher payouts for exceptionally valuable submissions that exceed expectations.
- **Sustainability:** These updates aim to ensure the long-term sustainability of the program, allowing us to remain responsive and collaborative with the ethical hacking community.

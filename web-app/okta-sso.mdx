...
description: "Configure Okta SSO (OIDC) for your Dune workspace, including domain verification and redirect URLs."
---

This guide walks you through enabling **Okta SSO** for your Dune workspace using **OIDC**.

## Prerequisites

You’ll need:

- Admin access in your **Dune workspace**
...
Back in Dune (**Workspace settings → Okta authentication**), fill in:

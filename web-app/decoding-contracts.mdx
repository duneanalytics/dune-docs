...
<Note>This automatic decoding pipeline is available for all [Fully Managed](../catalyst/fully-managed) chains on Dune. For [Hosted](../catalyst/fully-managed) chains, decoding can be [done manually](../query-engine/Functions-and-operators/evm-decoding-functions).</Note>
...
**[Proxy contract](https://info.etherscan.com/what-is-proxy-contract/):** Submit using the proxy address but with the ABI of the implementation.

...
Our decoding process begins with our [contract submission page](https://dune.com/docs/web-app/decoding-contracts/).

![](/web-app/images/decoding-contracts/1.png)
...
![](/web-app/images/decoding-contracts/2.png)

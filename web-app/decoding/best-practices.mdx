...
![](/web-app/images/decoding-contracts/mint_moment_tx.png)
...
<Accordion title="Step 1: Is your contract a proxy?">
  <p>
    <a href="https://etherscan.io/proxyContractChecker" target="_blank">Check using Etherscan Proxy Checker</a>
  </p>
  <p><b>If YES:</b></p>
  <ul>
  ...
  <p><b>If NO:</b> Go to Step 2</p>
</Accordion>

<Accordion title="Step 2: Is it created by a factory?">
  <p>
    <a href="https://docs.dune.com/web-app/decoding/decoding-contracts" target="_blank">Check Dune documentation for details</a>
  </p>
  <p><b>If YES:</b></p>
  <ul>
    <li>Enable "Decode other contracts created by the same factory" flags</li>
    <li>Submit the ABI for the created contracts, NOT the factory ABI</li>
    <li>Mark as factory-deployed in submission</li>
    <li>Include sample addresses of created contracts</li>
  </ul>
  <p><b>If NO:</b> Go to Step 3</p>
</Accordion>

<Accordion title="Step 3: Do all instances share identical bytecode?">
  <p>
    <a href="https://etherscan.io/find-similar-contracts" target="_blank">Verify using Etherscan Similar Contracts</a>
  </p>
  <p><b>If YES:</b></p>
  <ul>
...
### 2. Single Contract on Multiple Chains
...
### 4. Factory-Deployed Contracts (Multiple Chains)
...
### 5. Contracts with Identical Bytecode (Single Chain)
...
![](/proxy-find-implementation.png)

### 9. Proxy Contract (Single Chain)
...
### 10. Proxy Contract (Multiple Chains)
...
- **Contact Dune support** via Slack (For Enterprise Customers), Telegram (Paid Customers), [Discord](https://discord.com/invite/ErrzwBz), or email (support@dune.com) if you have questions about the submission process

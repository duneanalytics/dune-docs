...
<Accordion title="Step 1: Is your contract a proxy?">
  <p>
  <a href="https://etherscan.io/proxyContractChecker" target="_blank">
  Check using Etherscan Proxy Checker</a>
  ...
  <ul>
  <li>
  Use implementation ABI at proxy address</li>

  
  <li>
  Submit the proxy address</li>

  
  <li>
  Use the implementation contract's ABI (not the proxy's ABI)</li>

  
  <li>
  The implementation contains the actual business logic</li>
...
<Accordion title="Step 2: Is it created by a factory?">
  <p>
  <a href="https://docs.dune.com/web-app/decoding/decoding-contracts" target="_blank">
  Check Dune documentation for details</a>
  ...
  <ul>
  <li>
  Enable "Decode other contracts created by the same factory" flags</li>

  
  <li>
  Submit the ABI for the created contracts, NOT the factory ABI</li>

  
  <li>
  Mark as factory-deployed in submission</li>

  
  <li>
  Include sample addresses of created contracts</li>
...
<Accordion title="Step 3: Do all instances share identical bytecode?">
  <p>
  <a href="https://etherscan.io/find-similar-contracts" target="_blank">
  Verify using Etherscan Similar Contracts</a>
  ...
  <ul>
  <li>
  Enable bytecode matching</li>

  
  <li>
  Submit one ABI that covers all instances</li>

  
  <li>
  Check the "Enable bytecode matching" checkbox</li>

  
  <li>
  Note the shared bytecode pattern</li>
  ...
  <ul>
  <li>
  Standard submission process</li>

  
  <li>
  Submit the contract's ABI with the specific contract address and chain</li>
  ...
  <li>
  If unsure, always default to Standard Submission</li>

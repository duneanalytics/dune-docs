---
title: Alerts
description: Alerts allow you to receive notifications based on any query
---
...
>
  <iframe
    src="https://demo.arcade.software/6IfAf55RjoFQ5OCax9Zj?embed"
    frameBorder={0}
    loading="lazy"
...
<Warning>Alerts are not recommended for time-sensitive or critical applications at this stage.</Warning>
...
![Default email alert](/web-app/images/alerts/email_table.png)

If you have defined a visualization, we will include it instead of the table, like this:

![Email Alert with visualization](/web-app/images/alerts/email_viz.png)
...
![Email Alert with multiple visualizations](/web-app/images/alerts/email_complex.png)
...
Following these simple steps you can get query results posted directly in Slack at your desired frequency.
...
![Slack Setup](/web-app/images/alerts/slack_setup.png)

Once saved, you will start receiving messages on Slack. Here is an example of how it looks:

![Slack message](/web-app/images/alerts/slack_hook.png)
...
![Manual hook](/web-app/images/alerts/manual_hook.png)

Your setup on Zapier should look something like this:

![Zapier zap](/web-app/images/alerts/zapier_example.png)

...
![](/app/query-editor/images/version-history/version_start.PNG)
...
![](/app/query-editor/images/version-history/version_saved.PNG)

You can then edit the metadata of the saved version to make it easier to find in the future. 

![](/app/query-editor/images/version-history/simplified_query.gif)
...
![](/app/query-editor/images/version-history/compare_query.gif)
...
![list parameter](/app/query-editor/images/parameters/list-parameter.jpeg)
...
![parameter from query results](/app/query-editor/images/parameters/parameter-query-result.jpeg)

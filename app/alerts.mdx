...
![Default email alert](/app/images/alerts/email_table.png)

If you have defined a visualization, we will include it instead of the table, like this:

![Email Alert with visualization](/app/images/alerts/email_viz.png)
...
![Email Alert with multiple visualizations](/app/images/alerts/email_complex.png)
...
![Slack Setup](/app/images/alerts/slack_setup.png)

Once saved, you will start receiving messages on Slack. Here is an example of how it looks:

![Slack message](/app/images/alerts/slack_hook.png)
...
![Manual hook](/app/images/alerts/manual_hook.png)

Your setup on Zapier should look something like this:

![Zapier zap](/app/images/alerts/zapier_example.png)

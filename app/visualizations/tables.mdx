...
![query results table example](/app/images/other-visualizations/query-results-table-example.png)
...
![new table visualization](/app/images/other-visualizations/new-table-visualization.png)

### Configuring your Table

![table configuration options](/app/images/other-visualizations/table-configuration-options.png)
...
![table title example](/app/images/other-visualizations/table-title-example.png)
...
<Tabs>
  <Tab title="Type">
    ...
    ![progress bar example](/app/images/other-visualizations/progress-bar-example.gif)

  </Tab>
  <Tab title="Colored Values">
    ![colored values example](/app/images/other-visualizations/colored-values-example.jpeg)
  </Tab>
</Tabs>
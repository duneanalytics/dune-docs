...
Welcome to the Examples and Tutorials section! Here, you'll find a collection of code examples and step-by-step tutorials to help you get started with Dune and make the most out of its features.

#### Code Examples

Here are a few code examples demonstrating common use cases:
...
headers = {"X-DUNE-API-KEY": "<your_api_key>"}
payload = {"query_parameters": {"param1": 24}, "performance": "large"}
...
Explore our tutorials to learn how to perform common tasks and use Dune's features effectively:

* [Canceling an Execution](api-reference/executions/endpoint/cancel-execution)
* [Executing a Query](api-reference/executions/endpoint/execute-query)
* [Retrieving Execution Results in CSV](api-reference/executions/endpoint/get-execution-result-csv)
* [Getting Execution Results](api-reference/executions/endpoint/get-execution-result)
* [Checking Execution Status](api-reference/executions/endpoint/get-execution-status)

...
icon: "house"
description: Dune is a web-based platform that allows you to query public blockchain data and aggregate it into production-ready dashboards.
---
...
Ready to get started? Once you have an [account](https://dune.com/auth/register) and you have reviewed the [Quickstart](quickstart), check out these essentials to start using Dune.

...
<CardGroup cols={2}>
  <Card title="Upload data via the User Interface" icon="upload" href="/app/upload-data">
    Upload data via dune.com
    </Card>
  <Card title="Upload data via the API" icon="square-terminal" href="/api-reference/upload-data/index">

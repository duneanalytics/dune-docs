---
title: Decoding overview - ALT INDEX
...
You can check if contracts are already decoded by querying `[blockchain].contracts` tables, the data explorer or use [this dashboard](https://dune.com/dune/is-my-contract-decoded-yet-v2).

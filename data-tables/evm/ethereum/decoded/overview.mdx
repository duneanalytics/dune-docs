...
<CardGroup cols={2}>
  <Card
    ...
    icon="circle-bolt"
    iconType="duotone"
    href="/data-tables/evm/ethereum/decoded/event-logs"
  ></Card>
  <Card
    title="Explore decoded traces"
    icon="layer-group"
    iconType="duotone"
    href="/data-tables/evm/ethereum/decoded/call-tables"
  ></Card>
</CardGroup>
...
You can check if contracts are already decoded by querying [`[blockchain].contracts`](/data-tables/evm/ethereum/decoded/contracts) tables, the [data explorer](query-app/web-app/query-editor/data-explorer) or use [this dashboard](https://dune.com/dune/is-my-contract-decoded-yet-v2).
...
<CardGroup cols={2}>
  <Card
    ...
    icon="file-import"
    iconType="duotone"
    href="/query-app/web-app/decoding-contracts"
  ></Card>
  <Card
    title="Explore already decoded contracts"
    icon="database"
    iconType="duotone"
    href="/data-tables/evm/ethereum/decoded/contracts"
  ></Card>
</CardGroup>
...
![source: https://hackernoon.com/hn-images/1*Sz1a7G2pQ62UnkHoieve4w.jpeg](/data-tables/images/decoding.png)
...
![etherscan](/data-tables/images/etherscan.png)
...
Now what works for a single erc20 token, works for all erc20 tokens. We can use defined interfaces to decode the data of any erc20 token transfer event log. You can learn more about that in the [ERC20 transfer section](/data-tables/evm/ethereum/assets/transfers/erc20-transfers).

---
title: dex.trades on base
sidebarTitle: Dex Trades
description: "The `dex.trades` table captures detailed data on decentralized exchange (DEX) trades, recording all raw trade events across various protocols on base."
---
...
<DexTradesSnippet blockchain="base" />
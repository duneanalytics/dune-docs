---
title: dex.trades on flare
sidebarTitle: Dex Trades
description: "The `dex.trades` table captures detailed data on decentralized exchange (DEX) trades, recording all raw trade events across various protocols on flare."
---
...
<DexTradesSnippet blockchain="flare" />
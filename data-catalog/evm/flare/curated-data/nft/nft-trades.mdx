---
title: NFT Trades on Flare
sidebarTitle: NFT Trades
description: "The `nft.trades` table captures detailed data on NFT marketplaces, recording all trade events across various protocols on Flare."
---
...
<NFTTradesSnippet blockchain="flare" />

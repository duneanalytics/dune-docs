---
title: NFT.trades on polygon
sidebarTitle: NFT Trades
description: "The `nft.trades` table captures detailed data on NFT marketplaces, recording all trade events across various protocols on polygon."
---
...
<NFTTradesSnippet blockchain="polygon" />

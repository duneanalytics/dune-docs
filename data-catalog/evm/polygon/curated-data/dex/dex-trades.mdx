---
title: dex.trades on polygon
sidebarTitle: Dex Trades
description: "The `dex.trades` table captures detailed data on decentralized exchange (DEX) trades, recording all raw trade events across various protocols on polygon."
---
...
<DexTradesSnippet blockchain="polygon" />
---
title: NFT.trades on nova
sidebarTitle: NFT Trades
description: "The `nft.trades` table captures detailed data on NFT marketplaces, recording all trade events across various protocols on nova."
---
...
<NFTTradesSnippet blockchain="nova" />

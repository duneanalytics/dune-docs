---
title: NFT.trades on shape
sidebarTitle: NFT Trades
description: "The `nft.trades` table captures detailed data on NFT marketplaces, recording all trade events across various protocols on shape."
---
...
<NFTTradesSnippet blockchain="shape" />

---
title: dex.trades on megaeth
sidebarTitle: Dex Trades

description: "The `dex.trades` table captures detailed data on decentralized exchange (DEX) trades, recording all raw trade events across various protocols on megaeth."
---
...
<DexTradesSnippet blockchain="megaeth" />
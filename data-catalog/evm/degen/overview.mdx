...
<Info>
  The data for the degen tables is provided by the degen team. For more information, please refer to the [hosted chain section](/catalyst).
</Info>

<Warning>
 Traces and creation traces for this network are currently not available. 
</Warning>
...
<CardGroup cols={1}>
  <Card title="degen website" icon="link" href="https://https://www.degen.tips/">

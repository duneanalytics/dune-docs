---
title: dex.trades on apechain
sidebarTitle: "Dex Trades"
description: "The `dex.trades` table captures detailed data on decentralized exchange (DEX) trades, recording all raw trade events across various protocols on apechain."
---
...
<DexTradesSnippet blockchain="apechain" />
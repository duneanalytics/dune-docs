---
title: NFT.trades on kaia
sidebarTitle: NFT Trades
description: "The `nft.trades` table captures detailed data on NFT marketplaces, recording all trade events across various protocols on kaia."
---
...
<NFTTradesSnippet blockchain="kaia" />

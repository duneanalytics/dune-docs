---
title: dex.trades on kaia
sidebarTitle: Dex Trades
description: "The `dex.trades` table captures detailed data on decentralized exchange (DEX) trades, recording all raw trade events across various protocols on Kaia."
---
...
<DexTradesSnippet blockchain="kaia" />
---
title: dex.trades on avalanche
sidebarTitle: Dex Trades
description: "The `dex.trades` table captures detailed data on decentralized exchange (DEX) trades, recording all raw trade events across various protocols on avalanche."
---
...
<DexTradesSnippet blockchain="avalanche_c" />
---
title: dex.trades on berachain
sidebarTitle: Dex Trades
description: "The `dex.trades` table captures detailed data on decentralized exchange (DEX) trades, recording all raw trade events across various protocols on berachain."
---
...
<DexTradesSnippet blockchain="berachain" /> 
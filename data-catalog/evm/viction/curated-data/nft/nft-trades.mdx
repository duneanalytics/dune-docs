---
title: NFT.trades on viction
sidebarTitle: NFT Trades
description: "The `nft.trades` table captures detailed data on NFT marketplaces, recording all trade events across various protocols on viction."
---
...
<NFTTradesSnippet blockchain="viction" />

---
title: NFT.trades on linea
sidebarTitle: NFT Trades
description: "The `nft.trades` table captures detailed data on NFT marketplaces, recording all trade events across various protocols on linea."
---
...
<NFTTradesSnippet blockchain="linea" />

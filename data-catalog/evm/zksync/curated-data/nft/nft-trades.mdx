---
title: NFT.trades on zksync
sidebarTitle: NFT Trades
description: "The `nft.trades` table captures detailed data on NFT marketplaces, recording all trade events across various protocols on zksync."
---
...
<NFTTradesSnippet blockchain="zksync" />

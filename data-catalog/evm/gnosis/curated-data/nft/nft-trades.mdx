---
title: NFT.trades on gnosis
sidebarTitle: NFT Trades
description: "The `nft.trades` table captures detailed data on NFT marketplaces, recording all trade events across various protocols on gnosis."
---
...
<NFTTradesSnippet blockchain="gnosis" />

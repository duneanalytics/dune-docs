---
title: NFT.trades on bnb
sidebarTitle: NFT Trades
description: "The `nft.trades` table captures detailed data on NFT marketplaces, recording all trade events across various protocols on bnb."
---
...
<NFTTradesSnippet blockchain="bnb" />

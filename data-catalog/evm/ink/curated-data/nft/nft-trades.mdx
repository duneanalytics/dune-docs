---
title: NFT.trades on ink
sidebarTitle: NFT Trades
description: "The `nft.trades` table captures detailed data on NFT marketplaces, recording all trade events across various protocols on ink."
---
...
<NFTTradesSnippet blockchain="ink" />

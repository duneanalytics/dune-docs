---
title: NFT.trades on celo
sidebarTitle: NFT Trades
description: "The `nft.trades` table captures detailed data on NFT marketplaces, recording all trade events across various protocols on celo."
---
...
<NFTTradesSnippet blockchain="celo" />

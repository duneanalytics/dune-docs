---
title: NFT.trades on corn
sidebarTitle: NFT Trades
description: "The `nft.trades` table captures detailed data on NFT marketplaces, recording all trade events across various protocols on corn."
---
...
<NFTTradesSnippet blockchain="corn" />

---
title: dex_aggregator.trades on scroll
sidebarTitle: Aggregator Trades
description: Description of the Dex Aggregator Trades table for scroll
---
...
<DexAggregatorTradesSnippet blockchain="scroll" />
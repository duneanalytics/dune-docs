---
title: NFT.trades on blast
sidebarTitle: NFT Trades
description: "The `nft.trades` table captures detailed data on NFT marketplaces, recording all trade events across various protocols on blast."
---
...
<NFTTradesSnippet blockchain="blast" />

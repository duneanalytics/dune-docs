---
title: dex.trades on Blast
sidebarTitle: Dex Trades
description: "The `dex.trades` table captures detailed data on decentralized exchange (DEX) trades, recording all raw trade events across various protocols on Blast."
---
...
<DexTradesSnippet blockchain="blast" />
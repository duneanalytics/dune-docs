...
The `tokens_ethereum.balances` table contains all daily token balances across all addresses on EVM-compatible networks. This dataset encompasses:
...
#### Querying for latest fungible Token Balances for a specific Address

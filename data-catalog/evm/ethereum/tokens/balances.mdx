...
The `tokens_ethereum.balances` table contains all daily token balances across all addresses and on EVM-compatible networks. This dataset encompasses:
...
Balances are currently limited to:

---
title: NFT.trades on Polygon zkEVM
sidebarTitle: NFT Trades
description: "The `nft.trades` table captures detailed data on NFT marketplaces, recording all trade events across various protocols on Polygon zkEVM."
---
...
<NFTTradesSnippet blockchain="zkevm" />

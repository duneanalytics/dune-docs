---
title: dex_aggregator.trades on Polygon zkEVM
sidebarTitle: Aggregator Trades
description: Description of the Dex Aggregator Trades table for Polygon zkEVM
---
...
<DexAggregatorTradesSnippet blockchain="zkevm" />
...
## Table Description
Event data for trade account deposit on THORChain. This table is partitioned by day.
...
| **fact_trade_account_deposit_events_id** | bigint | Surrogate key for the fact record |

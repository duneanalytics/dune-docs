...
## Table Description
Event data for trade account withdraw on THORChain. This table is partitioned by day.
...
| **fact_trade_account_withdraw_events_id** | bigint | Surrogate key for the fact record |

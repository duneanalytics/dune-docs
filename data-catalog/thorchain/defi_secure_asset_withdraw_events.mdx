...
## Table Description
Event data for secure asset withdraw on THORChain. This table is partitioned by day.
...
| **fact_secure_asset_withdraw_events_id** | bigint | Surrogate key for the fact record |

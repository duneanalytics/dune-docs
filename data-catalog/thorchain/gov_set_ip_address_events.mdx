...
## Table Description
Event data for set ip address on THORChain. This table is partitioned by block_month.

## Column Descriptions
| **Column** | **Type** | **Description** |
|------------|----------|-----------------|
| **node_addr** | varchar | Node Addr |
| **ip_addr** | varchar | Ip Addr |
...
| **fact_set_ip_address_events_id** | bigint | Surrogate key for the fact record |

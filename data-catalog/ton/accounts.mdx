...
| **last_tx_at** | timestamp(3) with time zone | timestamp of the latest transaction | 
...
| **initial_funding_tx_hash** | varchar | Transaction hash with the first occurrence of account in transactions |
| **initial_funding_at** | timestamp(3) with time zone | Timestamp of the first occurrence of account in transactions |
| **first_tx_sender** | varchar | Raw address of who initiated the first transaction with this account |

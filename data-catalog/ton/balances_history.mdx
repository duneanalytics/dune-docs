...
## Table Description
Contains information about all balance changes for native TON and jettons. This table allows
to get point-in-time balance for each address as well as latest balances.

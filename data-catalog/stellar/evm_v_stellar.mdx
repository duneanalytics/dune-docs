...
EVM natively supports 3 transaction types: payment (regular), contract deployment, and execute contract, and does not have native support for Orderbook or AMMs.

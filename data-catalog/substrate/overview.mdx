...
<CardGroup cols={2}>
  ...
  <Card title="Calls" icon="arrow-right" href="/data-catalog/substrate/calls">
    Comprehensive log of function calls, expanding top-level extrinsics into individual actionable records.
  </Card>
  <Card title="Events" icon="bolt" href="/data-catalog/substrate/events">
    A chronological record of system events and state changes triggered by extrinsics or internal calls.
  </Card>
  ...
  <Card title="Materialized Views" icon="database" href="/data-catalog/substrate/materialized_views">
    Optimized data views storing pre-processed information from traces, streamlining access to pipelined chain data.
  </Card>
</CardGroup>

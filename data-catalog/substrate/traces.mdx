...
Traces table, also known as the "snapshot" table, stores relevant on-chain state data that are otherwise difficult to acquire from base tables such as extrinsics and events. Having these snapshots enables Dune wizards to build useful dashboards on Dune
such as :

...
| **updated_at**                      | timestamp   | Timestamp when the summary data was last updated.                                                 |
| **ingested_at**                     | timestamp   | Timestamp when the summary data was ingested into the database.                                   |

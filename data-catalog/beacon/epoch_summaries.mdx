...
| **updated_at**                   | timestamp   | Timestamp when the epoch summary was last updated.                                                |
| **ingested_at**                  | timestamp   | Timestamp when the epoch summary was ingested into the database.                                  |

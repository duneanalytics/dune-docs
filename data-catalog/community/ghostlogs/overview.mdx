...
Since anyone can replay transactions on a local fork and emit whatever events they want, this is also a great way for analysts to go into the past and extract data that would usually be very hard to come by. This can be useful for debugging, analysis, and more.  
...
**A wizard using GhostLogs in prod** : whale_hunter shares on [Twitter](https://x.com/whale_hunter_/status/1793348725244330470)

...
To understand how NEAR data flows, watch our [NEAR Data Flow video tutorial](/resources/learning/video-tutorials#near-data-flow) or visit the [NEAR documentation](https://docs.near.org/concepts/data-flow/near-data-flow).
...
<CardGroup cols={2}>
  ...
  <Card title="Function Calls" icon="file" href="/data-catalog/near/function_call">
    Contains flattened out actions of the  `function_call` type.
  </Card>

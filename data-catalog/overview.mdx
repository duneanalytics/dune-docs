...
<CardGroup cols={3}>
  ...
  <Card title="Decoded data" icon="file" href="./evm/ethereum/decoded/overview">
    ...
    <Card title="Curated data" icon="star" href="/data-catalog/spellbook/DEX/dex-trades"></Card>
</CardGroup>
...
Dune provides a wide range of abstraction tables that simplify the process of querying and analyzing blockchain data. These tables are built on top of raw data tables and provide a high-level view of the data.

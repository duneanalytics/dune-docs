---
title: tron.traces_decoded
sidebarTitle: "Decoded Traces"
description: Description of the tron.traces_decoded table on Dune
---
...
<ColumnDescriptions tableSchema="tron" tableName="traces_decoded" />

## Table Sample

import { TableSample } from "/snippets/table-sample.mdx";

<TableSample tableSchema="tron" tableName="traces_decoded" />

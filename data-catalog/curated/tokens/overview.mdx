...
<CardGroup cols={2}>
  <Card title="Balances" icon="scale-balanced" href="/data-catalog/spellbook/tokens/balances"> 
    The daily balances of tokens held by addresses.
    </Card>
  <Card
    title="Transfers" icon="layer-group" href="/data-catalog/spellbook/tokens/transfers">

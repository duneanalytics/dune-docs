...
The `tokens.transfers` table contains all token transfer events across ERC20 tokens and native tokens for all EVM-compatible networks indexed on Dune. This dataset encompasses:
...
Transfer data is collected from multiple sources:

- ERC20 Transfer events
- Native currency movements in transactions and traces

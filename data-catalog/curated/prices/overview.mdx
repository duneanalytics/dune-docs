...
- Coverage relies on [`dex.trades`](/data-catalog/curated/evm/DEX/dex-trades) entries for respective blockchain
...
You can test the coverage of prices.day, prices.hour, and prices.minute tables [here](https://dune.com/dune/does-dune-have-price-for-token).

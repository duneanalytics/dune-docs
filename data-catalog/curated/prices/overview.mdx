...
<Card title="Check Price Coverage" href="https://dune.com/dune/does-dune-have-price-for-token" icon="dashboard">
  You can test the coverage of prices.day, prices.hour, and prices.minute tables here.
</Card>

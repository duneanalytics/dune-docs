...
**Note**: While the table provides minute-level granularity, the underlying data sources are aligned to 5-minute intervals for consistency and improved data quality.

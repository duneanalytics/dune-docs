...
FROM "query_4419528(
    blockchain = 'base', 
    filter='address = 0x729170d38dd5449604f35f349fdfcc9ad08257cd', 
    native_token='ETH'
)"
...
**Note:** The `tokens_<chain>.balances` table is very large. The same query template pattern shown above must be used for efficient querying.

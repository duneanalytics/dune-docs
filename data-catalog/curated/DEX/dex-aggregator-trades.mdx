...
description: The `dex_aggregator.trades` table captures data on actions taken on aggregator protocols - recording all events across various aggregators and blockchains."
---

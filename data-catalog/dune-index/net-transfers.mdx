...
<CardGroup cols={1}>
  <Card title="Transfers Metrics Code" icon="code" href="https://github.com/duneanalytics/spellbook/tree/main/dbt_subprojects/daily_spellbook/models/_metrics/transfers">
    See the transfers metrics code for the technical implementation details.
  </Card>
</CardGroup>

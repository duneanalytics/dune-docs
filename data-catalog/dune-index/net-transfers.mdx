...
See the [transfers metrics code](https://github.com/duneanalytics/spellbook/tree/main/dbt_subprojects/daily_spellbook/models/_metrics/transfers) for the technical implementation details.

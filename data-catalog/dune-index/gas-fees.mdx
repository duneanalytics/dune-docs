...
<Tab title="Ethereum">
  ...
  Fee components: ```sql -- Four component fee structure blob_fee =
  blob_base_fee * blob_gas_used base_fee = base_fee_per_gas * gas_used
  priority_fee = priority_fee_per_gas * gas_used -- Three component fee
  structure (if no priority fee) blob_fee = blob_base_fee * blob_gas_used
  base_fee = gas_price * gas_used ```
</Tab>

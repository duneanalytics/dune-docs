...
For more details on the implementation, check out the [fees metrics code](https://github.com/duneanalytics/spellbook/tree/main/dbt_subprojects/daily_spellbook/models/_metrics/fees) in the Spellbook repository.

...
<Warning>
**The Dune Index has been sunset.** 

While we are no longer actively maintaining this product, the underlying methodology and queries remain fully accessible. You can still:
- **Query the underlying data** using the metrics tables referenced in this documentation (e.g., `metrics.gas_fees_daily`)
- **Use our methodology** by referencing the [Spellbook repository code](https://github.com/duneanalytics/spellbook/tree/main/dbt_subprojects/daily_spellbook/models/_metrics/dune_index)
- **Build your own analysis** based on the component metrics described below
</Warning>

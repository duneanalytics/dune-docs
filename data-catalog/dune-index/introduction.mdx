...
Together, these metrics create a robust framework that resists artificial inflation and captures different aspects of blockchain utility. For implementation details, see the [Dune Index metrics code](https://github.com/duneanalytics/spellbook/tree/main/dbt_subprojects/daily_spellbook/models/_metrics/dune_index) in the Spellbook repository.

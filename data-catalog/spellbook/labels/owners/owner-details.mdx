...
The `labels.owner_details` table on Dune Analytics provides essential information about various entities within the ecosystem, detailing their operational, social, and technical profiles.
